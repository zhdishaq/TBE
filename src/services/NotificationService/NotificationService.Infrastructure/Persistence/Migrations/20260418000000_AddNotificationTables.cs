...
namespace TBE.NotificationService.Infrastructure.Persistence.Migrations
{
    ...
    public partial class AddNotificationTables : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            // ---- MassTransit inbox/outbox tables (copied from BookingService.AddBookingSagaState) ----
            ...
            // ---- NOTF-06 EmailIdempotencyLog ----
            migrationBuilder.CreateTable(
                name: "EmailIdempotencyLog",
                schema: "notification",
                columns: table => new
                {
                    Id = table.Column<long>(type: "bigint", nullable: false)
                    ...
                    EmailType = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EmailIdempotencyLog", x => x.Id);
                });

            migrationBuilder.CreateIndex(
                name: "IX_EmailIdempotencyLog_EventId_EmailType",
                schema: "notification",
                table: "EmailIdempotencyLog",
        ...
        {
            migrationBuilder.DropTable(name: "EmailIdempotencyLog", schema: "notification");
