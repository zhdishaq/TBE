...
```
  ...
  <verify>
    <automated>cd /c/Users/zhdishaq/source/repos/TBE && dotnet test tests/TBE.Tests.Unit/TBE.Tests.Unit.csproj --filter "HotelbedsHmac|HotelbedsProvider" --no-build 2>&1 | tail -10</automated>
  </verify>
...
**TBE.Tests.Unit.csproj** — already has HotelConnectorService.Application reference from Task 1. Confirm it's there; no additional change needed.
  ...
  <verify>
    <automated>cd /c/Users/zhdishaq/source/repos/TBE && dotnet test tests/TBE.Tests.Unit/TBE.Tests.Unit.csproj --filter "CarProvider" --no-build 2>&1 | tail -10</automated>
  </verify>
