...
```
  ...
  <verify>
    <automated>cd /c/Users/zhdishaq/source/repos/TBE && dotnet test tests/TBE.Tests.Unit/TBE.Tests.Unit.csproj --filter "SabreProvider" 2>&1 | tail -10</automated>
  </verify>
...
```
  ...
  <verify>
    <automated>cd /c/Users/zhdishaq/source/repos/TBE && dotnet test tests/TBE.Tests.Unit/TBE.Tests.Unit.csproj --filter "FanOut" 2>&1 | tail -10</automated>
  </verify>
