...
- [x] 04-04-PLAN.md — Car hire + Trip Builder: car + transfer search + car voucher, Baskets table + BasketsController + BasketPaymentOrchestrator using Option A two-PaymentIntents with deterministic idempotency keys, combined email (full & partial-failure per D-09) via BasketConfirmedConsumer (CARB-01..03, PKG-01..04)
